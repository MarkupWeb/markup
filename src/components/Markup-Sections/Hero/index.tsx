...
import ContactPopup from "@/components/Common/Dialog-PopUp/ContactPopUp/ContactPopup";
...
const Hero = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className={`relative z-10 overflow-hidden bg-blue-100 pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px] `}
      >
                  ...
                  ? heroContent.map((item) => (
                      <div className="" key={item.id}>
                        ...
                        <div className="flex items-center">
                          <button
                            className=" mr-6 flex   items-center gap-4  rounded-3xl border-2 border-orange-400    px-6 py-2.5 font-semibold text-black hover:bg-orange-400 hover:text-white dark:text-white lg:px-8 lg:py-4"
                            onClick={() => setIsOpens(true)}
                          >
                            <span className="text-[12px] md:text[14px] lg:text-[12px]">
                              {item.btnTitle1}
                            </span>
                            <span className="scale-x transform ">
                              <HiOutlinePhone />
                            </span>
                          </button>
