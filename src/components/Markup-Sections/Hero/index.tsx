...
const Hero = () => {
  ...
  return (
    <>
      <section
        id="home"
        className={`relative z-10 overflow-hidden bg-blue-50 pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px] `}
      >
        <ModalVideo
          channel="youtube"
          isOpen={isOpen}
