...
const Footer2 = () => {
    return (
        ...
        <section className="mx-auto max-w-2xl sm:pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    <div className="flex flex-shrink-0 items-center border-right">
                        <Image src="/icons/logo-mark.png" alt="logo" width={214} height={66} />
                    </div>
                    ...
                    <div className='flex gap-4'>
                        ...
                        <Link href={items.link} key={i}>
                            <div className="bg-white h-12 w-12 shadow-xl text-base rounded-full flex items-center justify-center footer-icons hover:bg-orange-500 hover:-translate-y-3">
                                <span className="">
                                    <FaFacebookF />
                                </span>
                            </div>
