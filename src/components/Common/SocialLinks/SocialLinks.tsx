    ...
    <div className="flex gap-4">
      {socialLinks.map((items, i) => (
        <Link href={items.link} key={i} target="_blank">
          <div className="bg-white text-slate-900 hover:text-white  h-12 w-12 shadow-xl text-base rounded-full flex items-center justify-center footer-icons hover:bg-orange-500  hover:-translate-y-1 hover:transition-all duration-300">
